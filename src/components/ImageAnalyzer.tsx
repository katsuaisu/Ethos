    ...
    try {
      const res = await fetch(ANALYZE_URL, {
        ...
        body: JSON.stringify({
          ...
          prompt: "Analyze this image thoroughly. Extract key themes, generate a detailed mindmap structure, and suggest how this could be organized on a board.",
        }),
      });
      ...
      {!preview ? (
        ...
        >
          ...
          <p className="text-xs text-muted-foreground/60">
            AI will analyze, categorize & generate mindmaps
          </p>
        </motion.div>
      ) : (
